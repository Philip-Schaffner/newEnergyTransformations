 ...
 */
public class HttpInLoopTransformation extends Refactoring {

    public HttpInLoopTransformation(){
        super();
        ...
        if (element instanceof PsiAnonymousClass && classOfTimer != null) {
            ...
            switch (className) {
                case "java.util.TimerTask":
                    ...
                    PsiElement newDelayTime = elementFactory.createExpressionFromText("(long)(" + delayTime.getText() + "*this.getSleepTimer())",delayTime);
